...
export const Icon: React.FC<IconProps> = ({ name, className, ...props }) => {
  const icons: { [key: string]: React.ReactNode } = {
    ...
    chevronUp: (
        <svg fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" {...props}><polyline points="18 15 12 9 6 15"></polyline></svg>
    ),
    image: (
